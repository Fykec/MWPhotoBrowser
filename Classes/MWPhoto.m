...
@interface MWPhoto () {
    ...
    UIImageView *_imageDownloadProxyView;
...
- (void)performLoadUnderlyingImageAndNotify {
    ...
    if (_image) {
        ...
        if ([[[_photoURL scheme] lowercaseString] isEqualToString:@"assets-library"]) {
            ...
            _imageDownloadProxyView = [UIImageView new];
            [_imageDownloadProxyView setImageWithURLRequest:[NSURLRequest requestWithURL:_photoURL] placeholderImage:nil success:^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *image) {
                [weakSelf setUnderlyingImage:image];
...
- (void)cancelAnyLoading {
    if (_imageDownloadProxyView) {
        [_imageDownloadProxyView cancelImageRequestOperation];
        _loadingInProgress = NO;
    }
}
